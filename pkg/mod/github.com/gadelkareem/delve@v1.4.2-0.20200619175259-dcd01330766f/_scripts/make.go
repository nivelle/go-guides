...
const DelveMainPackagePath = "github.com/gadelkareem/delve/cmd/dlv"
...
`,
	...
	integration 	tests github.com/gadelkareem/delve/service/test
...
func testSetToPackages(testSet string) []string {
	...
	case "basic":
		return []string{"github.com/gadelkareem/delve/pkg/proc", "github.com/gadelkareem/delve/service/test", "github.com/gadelkareem/delve/pkg/terminal"}

	case "integration":
		return []string{"github.com/gadelkareem/delve/service/test"}
